...
export default class DogWalkers extends React.Component {
  ...
  componentDidMount(){
    ...
    hiredDogWalkers.push(this.props.dogWalkerProfile)
      ...
      //console.log("datos:",this.props.dogWalkerProfile)
      console.log("dias:",this.props.reservedDays)
  }
  ...
  render(){
    ...
    return(
        <DogWalkerProfile data={this.props.dogWalkerProfile} navigation={this.state.navigation} parentScreen={"DogWalkers"}/> 
    )
  }
}
}
